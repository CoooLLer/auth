...
type UserV1Client interface {
	Create(ctx context.Context, in *CreateUserIn, opts ...grpc.CallOption) (*CreateUserOut, error)
	Get(ctx context.Context, in *GetUserIn, opts ...grpc.CallOption) (*GetUserOut, error)
	Update(ctx context.Context, in *UpdateUserIn, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Delete(ctx context.Context, in *DeleteUserIn, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *userV1Client) Create(ctx context.Context, in *CreateUserIn, opts ...grpc.CallOption) (*CreateUserOut, error) {
...
func (c *userV1Client) Get(ctx context.Context, in *GetUserIn, opts ...grpc.CallOption) (*GetUserOut, error) {
	out := new(GetUserOut)
...
func (c *userV1Client) Update(ctx context.Context, in *UpdateUserIn, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *userV1Client) Delete(ctx context.Context, in *DeleteUserIn, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type UserV1Server interface {
	...
	Get(context.Context, *GetUserIn) (*GetUserOut, error)
	Update(context.Context, *UpdateUserIn) (*emptypb.Empty, error)
	Delete(context.Context, *DeleteUserIn) (*emptypb.Empty, error)
...
func (UnimplementedUserV1Server) Create(context.Context, *CreateUserIn) (*CreateUserOut, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedUserV1Server) Get(context.Context, *GetUserIn) (*GetUserOut, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedUserV1Server) Update(context.Context, *UpdateUserIn) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedUserV1Server) Delete(context.Context, *DeleteUserIn) (*emptypb.Empty, error) {
...
func _UserV1_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).Create(ctx, req.(*CreateUserIn))
	}
...
func _UserV1_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).Get(ctx, req.(*GetUserIn))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserV1_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).Update(ctx, req.(*UpdateUserIn))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserV1_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).Delete(ctx, req.(*DeleteUserIn))
	}
	return interceptor(ctx, in, info, handler)
}
